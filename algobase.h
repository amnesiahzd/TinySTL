...
/*****************************************************************************************/
// unchecked_copy_backward_cat 的 bidirectional_iterator_base 版本
template <class BidirectionalIter1, class BidirectionalIter2>
BidirectionalIter2 
unchecked_copy_backward_cat(BidirectionalIter1 first, BidirectionalIter1 last,
                            BidirectionalIter2 result, TinySTL::bidirectional_iterator_base)
{
  while (first != last)
    *--result = *--last;
  return result;
...
// unchecked_copy_backward_cat 的 random_access_iterator_base 版本
template <class RandomIter1, class BidirectionalIter2>
BidirectionalIter2 
unchecked_copy_backward_cat(RandomIter1 first, RandomIter1 last,
                            BidirectionalIter2 result, TinySTL::random_access_iterator_base)
{
...
TinySTL::pair<InputIter, OutputIter>
unchecked_copy_n(InputIter first, Size n, OutputIter result, TinySTL::input_iterator_base)
{
...
TinySTL::pair<RandomIter, OutputIter>
...
/*****************************************************************************************/
// bidirectional_iterator_base 版本
template <class BidirectionalIter1, class BidirectionalIter2>
BidirectionalIter2
